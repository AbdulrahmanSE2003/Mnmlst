                ...
                >
                    {stats.map((stat, i) => (
                        <motion.div
                            key={i}
                            variants={item}
                            className={`flex flex-col justify-center items-center rounded-2xl shadow-lg bg-white dark:bg-gray-900 p-8 group hover:shadow-xl transition duration-300 hover:-translate-y-[6px] ${
